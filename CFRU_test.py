...
if __name__ == '__main__':
    offline_unlearn_important(
        log_folder='./fedtasksave', 
        task_name='movielens1m_cnum100_dist0_skew0_seed0', 
        hist_dirty_name='ULOpt_NCF_Mu8_R40_P0.30_alpha0.09_seed0_fedAttack', 
        alp=0.5,
        num_round=40, 
        num_neg=1, 
        model = 'NCF', 
        atk_method = 'fedAttack'
        )
