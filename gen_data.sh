...
python generate_fedtask.py --dataset movielens1m --dist 11 --skew 0 --num_clients 100
# python generate_fedtask.py --dataset pinterest --dist 11 --skew 0 --num_clients 50
